...
System.register(['lodash', 'moment', 'angular', '../exporter'], function(exports_1) {
    var lodash_1, moment_1, angular_1, exporter_1;
    var DashNavCtrl;
            ...
            DashNavCtrl = (function () {
                ...
                function DashNavCtrl($scope, $rootScope, alertSrv, $location, playlistSrv, backendSrv, $timeout, datasourceSrv) {
                    ...
                    $scope.exportDashboard = function () {
                        var clone = $scope.dashboard.getSaveModelClone();
                        var exporter = new exporter_1.DashboardExporter(datasourceSrv);
