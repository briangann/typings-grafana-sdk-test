...
System.register(['app/core/config', 'angular', 'app/core/core_module', './dynamic_dashboard_srv'], function(exports_1) {
    var config_1, angular_1, core_module_1, dynamic_dashboard_srv_1;
    var DashboardCtrl;
    return {
        setters:[
            function (config_1_1) {
        ...
        execute: function() {
            DashboardCtrl = (function () {
                /** @ngInject */
                function DashboardCtrl($scope, $rootScope, dashboardKeybindings, timeSrv, templateValuesSrv, dashboardSrv, unsavedChangesSrv, dashboardViewStateSrv, contextSrv, $timeout) {
                    this.$scope = $scope;
                    this.$rootScope = $rootScope;
                    $scope.editor = { index: 0 };
                    $scope.panels = config_1.default.panels;
                    $scope.dynamicDashboardSrv = new dynamic_dashboard_srv_1.DynamicDashboardSrv();
